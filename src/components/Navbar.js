...
import logo from '../assets/bt-block.gif';
import './main.css';
    ...
    <div id='navbar-container'>
        <div id='navbar-inner'>
            ...
            <div id='navbar-middle'>
                <a id='about-me-link' className='nav-mid-links' href="#about-me">{'< About Me >'}</a>
                <a id='projects-link' className='nav-mid-links' href="#projects">{'< Projects >'}</a>
            </div>
            <div id='navbar-right-section'>

                <a className='nav-link' href='mailto: brandon.tasaki@gmail.com'>
                    <div className='email'>
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                         width="58.877px" height="40px" viewBox="0 0 970.000000 659.000000"
                         preserveAspectRatio="xMidYMid meet">
                            <g id='email-g' transform="translate(0.000000,659.000000) scale(0.100000,-0.100000)"
                            stroke="none">
                            <path d="M994 6564 c-295 -49 -572 -219 -750 -460 -110 -147 -176 -297 -214
                            -482 -20 -99 -20 -124 -20 -2327 0 -2203 0 -2228 20 -2327 27 -130 52 -202
                            108 -312 172 -337 493 -571 865 -631 139 -23 7555 -23 7694 0 372 60 693 294
                            865 631 56 110 81 182 108 312 20 99 20 124 20 2327 0 2203 0 2228 -20 2327
                            -27 130 -52 202 -108 312 -143 279 -384 486 -680 585 -196 65 99 61 -4042 60
                            -3119 -1 -3779 -3 -3846 -15z m6909 -772 c-53 -40 -3042 -1962 -3053 -1962
                            -10 0 -3044 1951 -3064 1971 -6 5 1185 9 3065 9 2915 0 3073 -1 3052 -18z
                            m-5049 -1746 c1945 -1250 1854 -1196 1996 -1196 142 0 40 -61 2131 1283 l1934
                            1243 3 -2130 c2 -2364 8 -2170 -63 -2281 -55 -87 -127 -141 -224 -171 -69 -21
                            -7493 -21 -7562 0 -97 30 -169 84 -224 171 -71 111 -65 -85 -65 2282 l0 2132
                            138 -88 c75 -49 946 -609 1936 -1245z"/>
                            </g>
                        </svg>
                    </div>
                </a>
                <a className='nav-link' href='https://github.com/MacFlyOSX/' rel="noopener noreferrer" target='_blank'>
                ...
                <a href='https://www.linkedin.com/in/brandon-tasaki/' rel="noopener noreferrer" target='_blank'>
                    <div className='linkedin'>
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                        width="50px" height="50px" viewBox="0 0 2361.000000 2361.000000"
                        preserveAspectRatio="xMidYMid meet">
